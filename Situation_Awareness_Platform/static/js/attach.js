var worldChart = echarts.init(document.getElementById('world-chart'));
...
var geoCoordMapData = {
 ...
 var XAData = [
   ...
   [{ name: '阿尔巴尼亚' }, { name: '白俄罗斯', value: 30 }],
   [{ name: '布隆迪' }, { name: '白俄罗斯', value: 30 }],
   [{ name: '北京' }, { name: '巴西,阿雷格里港', value: 20 }],
 ]
 var arrowPath = 'path://M854.016 739.328l-313.344-309.248-313.344 309.248q-14.336 14.336-32.768 21.504t-37.376 7.168-36.864-7.168-32.256-21.504q-29.696-28.672-29.696-68.608t29.696-68.608l376.832-373.76q14.336-14.336 34.304-22.528t40.448-9.216 39.424 5.12 31.232 20.48l382.976 379.904q28.672 28.672 28.672 68.608t-28.672 68.608q-14.336 14.336-32.768 21.504t-37.376 7.168-36.864-7.168-32.256-21.504z';
 ...
 var color = ['#00eaff', '#00eaff', '#00eaff'];//航线的颜色
 var option = {
    ...
    tooltip: {
       ...
       formatter: function (params, ticket, callback) {
          if (params.seriesType == "effectScatter") {
             ...
             return params.data.fromName + ">" + params.data.toName + "<br />" + params.data.value + "次";
          } else {
             return params.name;
          }
       }
 ...
 [['广州', XAData]].forEach(function (item, i) {
    option.series.push({
       name: item[0] + ' Top3',
       type: 'lines',
       zlevel: 1,
       ...
       },
       {
          ...
          data: item[1].map(function (dataItem) {
             if (geoCoordMapData.hasOwnProperty(dataItem[1].name) === true) {
                return {
